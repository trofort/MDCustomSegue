...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MDCustomSegue.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/maksim.dehanov@mail.ru/MDCustomSegue'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'maksim.dehanov@mail.ru' => 'maksim.dehanov@mail.ru' }
  s.source           = { :git => 'https://github.com/maksim.dehanov@mail.ru/MDCustomSegue.git', :tag => s.version.to_s }
